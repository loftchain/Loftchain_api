...
class EthService
{
  ...
  {
    $client = new Client();
    $res = $client->request('GET', 'http://'. env("ETHERSCAN_API_PREFIX").'.etherscan.io/api?module=account&action=txlist&address=' . $eth_wallet . '&sort=asc&apikey=' . env('ETHERSCAN_API_KEY'));
